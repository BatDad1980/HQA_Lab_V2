...
SAFE_COMMANDS = [
    ...
    ("BACL fail-closed authority contract", ["python", "hqa_v2/integrations/bacl_fail_closed_authority_contract_v0.py"]),
    ("BACL fail-closed authority contract gate", ["python", "hqa_v2/quality/bacl_fail_closed_authority_contract_gate.py"]),
    ...
    ("HAL loopback boundary contract", ["python", "hqa_v2/integrations/hal_loopback_boundary_contract_v0.py"]),
    ("HAL loopback boundary contract gate", ["python", "hqa_v2/quality/hal_loopback_boundary_contract_gate.py"]),
    ("HAL pump hysteresis contract", ["python", "hqa_v2/integrations/hal_pump_hysteresis_contract_v0.py"]),
    ("HAL pump hysteresis contract gate", ["python", "hqa_v2/quality/hal_pump_hysteresis_contract_gate.py"]),
    ...
    ("IBM live validation abstention replay", ["python", "hqa_v2/integrations/ibm_live_validation_abstention_replay_v0.py"]),
    ("IBM live validation abstention replay gate", ["python", "hqa_v2/quality/ibm_live_validation_abstention_replay_gate.py"]),
