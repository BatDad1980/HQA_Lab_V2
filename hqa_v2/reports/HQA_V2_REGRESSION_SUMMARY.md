...
| Topology routing | PASS | 0.089 | `python hqa_v2/demos/hqa_topology_routing_demo.py` |
| Live telemetry | PASS | 0.594 | `python hqa_v2/demos/hqa_live_control_loop_demo.py` |
...
| Analog pulse shaping | PASS | 0.084 | `python hqa_v2/demos/hqa_analog_pulse_demo.py` |
...
| Simulator adapter smoke | PASS | 0.075 | `python hqa_v2/quality/simulator_adapter_smoke_test.py` |
| Qiskit cascade observer | PASS | 0.714 | `python hqa_v2/integrations/qiskit_cascade_observer.py` |
| Qiskit Aer cascade noise probe | PASS | 0.972 | `python hqa_v2/integrations/qiskit_aer_cascade_noise_probe.py` |
| Qiskit Aer cascade gate | PASS | 0.061 | `python hqa_v2/quality/qiskit_aer_cascade_gate.py` |
| Stress harness | PASS | 0.065 | `python hqa_v2/demos/hqa_stress_harness.py` |
| Deterministic stress scenarios | PASS | 0.109 | `python hqa_v2/quality/hqa_v2_stress_scenarios.py` |
