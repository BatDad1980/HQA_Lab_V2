...
|---|---:|---:|---:|---|---|
| `qiskit_aer` | `True` | `True` | `1.144716` | `{'11': 127, '00': 129}` | Local Aer simulation only; no live backend job submitted. |
| `cirq` | `True` | `True` | `0.001958` | `{'00': 127, '11': 129}` | Local Cirq/qsim simulation only; no live backend job submitted. |
