...
|---|---:|---:|---:|---|---|
| `qiskit_aer` | `True` | `True` | `0.134451` | `{'11': 127, '00': 129}` | Local Aer simulation only; no live backend job submitted. |
| `cirq` | `True` | `True` | `0.002786` | `{'00': 135, '11': 121}` | Local Cirq/qsim simulation only; no live backend job submitted. |
