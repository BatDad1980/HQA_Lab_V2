...
| `hqa_v2/reports/HQA_QUANTUM_JEDI_STORM_LANE_AUDIT_INTAKE_2026_06_03.md` | Records read-only audit findings from the separate Quantum Jedi storm lane and identifies safe harvest candidates. |
