...
HQA should test two families in parallel:

- Cat-qubit/bosonic evidence for Alice & Bob style systems.
- Non-cat topology/syndrome evidence for IBM, Google, and neutral vendor graphs.

The goal is not to collapse those systems into one claim. The goal is to keep one HQA intake and advisory grammar while preserving each vendor's hardware geometry and evidence class.
...
- `hqa_v2/integrations/dual_vendor_test_matrix_v0.py`
- `hqa_v2/quality/dual_vendor_test_matrix_gate.py`
